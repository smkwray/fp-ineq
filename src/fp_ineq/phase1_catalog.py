...
PHASE1_SCENARIOS = (
    ...
    Phase1ScenarioSpec(
        ...
        trfin_fed_share=1.0,
        trfin_sl_share=1.0,
        transfer_description="Small repaired transfer-composite package through UB, TRGH, and TRSH with full financing shares.",
    ...
    Phase1ScenarioSpec(
        ...
        trfin_fed_share=1.0,
        trfin_sl_share=1.0,
        transfer_description="Medium repaired transfer-composite package through UB, TRGH, and TRSH with full financing shares.",
    ...
    Phase1ScenarioSpec(
        ...
        trfin_fed_share=1.0,
        trfin_sl_share=1.0,
        transfer_description="Large repaired transfer-composite package through UB, TRGH, and TRSH with full financing shares.",
